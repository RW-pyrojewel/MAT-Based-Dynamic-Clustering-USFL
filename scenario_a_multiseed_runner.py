...
METRICS = (
    ...
    "ppo_grad_norm_pre",
    "ppo_grad_norm_post",
    "ppo_grad_norm_pre_max",
    "ppo_grad_norm_post_max",
    "ppo_encoder_grad_norm_pre",
    "ppo_encoder_grad_norm_post",
    "ppo_value_head_grad_norm_pre",
    "ppo_value_head_grad_norm_post",
    "ppo_decoder_grad_norm_pre",
    "ppo_decoder_grad_norm_post",
    "ppo_split_head_grad_norm_pre",
    "ppo_split_head_grad_norm_post",
    "ppo_online_value_mean",
    "ppo_target_value_mean",
    "ppo_online_target_value_drift",
    "ppo_ppo_epochs_run",
    "ppo_kl_early_stop",
    "ppo_transition_count",
    "ppo_policy_version_count",
    "ppo_target_drift_during_update",
    "ppo_station_1_return_mean",
    "ppo_station_1_return_std",
    "ppo_station_1_td_residual_mean",
    "ppo_station_1_td_residual_std",
    "ppo_station_1_explained_variance",
    "ppo_station_2_return_mean",
    "ppo_station_2_return_std",
    "ppo_station_2_td_residual_mean",
    "ppo_station_2_td_residual_std",
    "ppo_station_2_explained_variance",
    "ppo_station_3_return_mean",
    "ppo_station_3_return_std",
    "ppo_station_3_td_residual_mean",
    "ppo_station_3_td_residual_std",
